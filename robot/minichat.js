...
;(function ($, window, document, undefined) {
  ...
  Faqrobot.prototype = {
    ...
    sendMsg: function(){
        var This = this;
        var s_msg='';
        s_msg=$("#"+This.options.inputCtnId).val();
        //空过滤
	    if(!s_msg){
            s_msg===0 ? "0" : "";
        }
    ...
    leaveQue: function (data) {
      if (data.leaveQue) {
        if (data.leaveQue[0]) {
          $('.MN_answer .MN_kfCtn').append('<div class="MN_leaveQueCtn"><div class="MN_leaveQueTop"><span>这里有您的留言，</span><span class="MN_lookLeaveQue">点击查看</span></div><div class="MN_leaveQueBottom"></div></div>')
